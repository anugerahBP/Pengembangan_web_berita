...
include "koneksi.php";
$ambil_data = mysqli_query($offset, $dataPerPage,  $koneksi, "SELECT * FROM tbl_berita order by id_berita desc limit");
$hitung_record = mysqli_query("SELECT COUNT(*) AS jumData FROM tbl_berita", $koneksi);
...
<div class="row-fluid">
    <div class="span4">
        <img data-src="holder.js/300x200" alt="300x200" src="<?= $hasil_data['gambar']; ?>"
    ...
    <div class="span8">
        ...
        <p>
            <a href="index.php?link=lihatDetailBerita.php&id=<?= $hasil_data['id_berita']; ?>"
